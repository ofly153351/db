                ...
                <div class="selectform">
                    <div class="col-form">
                        <div class="boxselect">
                            ...
                            <div class="input1">
                                <label>
                                    <input style="width: 250px;" required="" placeholder="กลุ่มเรียน" value="<?php echo "$section" ?>" type="text" name="sectionn" class="input">
                                </label>
                            </div>
                            <div class="input1">
                                <label>
                        ...
                        <div class="containerupload">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url(../image/user-2-fill.png); width: auto;  ">
                                    </div>
                                </div>
                            </div>
                        </div>
