...
-- Dumping structure for table database.branch
CREATE TABLE IF NOT EXISTS `branch` (
  `branch_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `branch_id` int NOT NULL AUTO_INCREMENT,
  `faculty_id` int DEFAULT NULL,
  `innitial` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`branch_id`),
  KEY `faculty_id` (`faculty_id`),
  KEY `innitial` (`innitial`),
  CONSTRAINT `FK_branch_faculty` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=1835 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table database.branch: ~35 rows (approximately)
DELETE FROM `branch`;
...
-- Dumping structure for table database.faculty
CREATE TABLE IF NOT EXISTS `faculty` (
  `faculty_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for table database.student_info
CREATE TABLE IF NOT EXISTS `student_info` (
  ...
  `innitial` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sectionn` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `expi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `teacher` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `birth_date` date DEFAULT NULL,
  `old_school` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`user_id`),
  KEY `FK_student_info_branch` (`branch`),
  KEY `FK_student_info_faculty` (`faculty`),
  KEY `FK_student_info_user_role` (`role_account`),
  KEY `order` (`number`) USING BTREE,
  KEY `FK_student_info_innitial` (`innitial`),
  CONSTRAINT `FK_student_info_branch` FOREIGN KEY (`branch`) REFERENCES `branch` (`branch_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `FK_student_info_faculty` FOREIGN KEY (`faculty`) REFERENCES `faculty` (`faculty_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `FK_student_info_innitial` FOREIGN KEY (`innitial`) REFERENCES `branch` (`innitial`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `FK_student_info_user_role` FOREIGN KEY (`role_account`) REFERENCES `user_role` (`role_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table database.student_info: ~2 rows (approximately)
